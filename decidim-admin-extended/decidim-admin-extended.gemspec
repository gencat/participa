...
Gem::Specification.new do |s|
  ...
  s.add_dependency "decidim-core", "~> 0.8.4"
  s.add_dependency "decidim-admin", "~> 0.8.4"

  s.add_development_dependency "decidim-admin", "~> 0.8.4"
  s.add_development_dependency "decidim-dev", "~> 0.8.4"
end
