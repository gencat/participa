...
ruby RUBY_VERSION
DECIDIM_VERSION = { git:    'https://github.com/CodiTramuntana/decidim',
                    branch: 'publish_duplicated_questionnaires' }.freeze

gem "decidim", DECIDIM_VERSION

#### Custom gems and modifciations block start ####
gem 'decidim-department_admin', git: 'https://github.com/gencat/decidim-department-admin.git', tag: 'v0.0.13'
