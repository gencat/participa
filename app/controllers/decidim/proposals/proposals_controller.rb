...
module Decidim
  module Proposals
    ...
    class ProposalsController < Decidim::Proposals::ApplicationController
      ...
      helper_method :proposal_presenter, :form_presenter, :most_voted_positive_comment, :most_voted_negative_comment, :comment_author, :more_positive_comment, :get_comment, :comment_author_avatar, :get_positive_count_comment, :get_negative_count_comment
